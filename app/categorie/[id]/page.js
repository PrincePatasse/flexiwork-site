...
const CATEGORY_META = {
  ...
  'sous-location': {
    icon: '🔄',
    title: 'Sous-location',
    description: 'Valorisez vos espaces vacants. Récupérez jusqua 180K€ par an en optimisant votre occupation. Solution flexible pour espaces sous-utilisés.',
  },
  acquisition: {
    icon: '🏛️',
    title: 'Acquisition',
    description: 'Investissement immobilier patrimonial. Optimisation fiscale et indépendance locative. Constitution dactifs immobiliers professionnels.',
  },
}
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mt-20 bg-white border-2 border-gray-200 rounded-2xl p-10 text-center max-w-2xl mx-auto">
          <h3 className="text-xl font-bold mb-4">Besoin dinformations ?</h3>
